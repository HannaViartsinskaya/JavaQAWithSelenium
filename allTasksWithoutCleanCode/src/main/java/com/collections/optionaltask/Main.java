...
//        Scanner sc=new Scanner((new File("./src/main/resources/read1.txt")));
...
//        sc.close();
//
//        FileWriter nameFile = new FileWriter("./src/main/resources/write1.txt");
//        while(!strings.empty()) {
...
//       String usersString="";
//        Scanner sc=new Scanner((new File("./src/main/resources/7exercise.txt")));
//    while(sc.hasNextLine())
//    {
...
//        Scanner sc=new Scanner((new File("./src/main/resources/6exercise.txt")));
//        while(sc.hasNextLine())
//        {
...
//        Scanner sc=new Scanner((new File("./src/main/resources/4exercise.txt")));
//        while(sc.hasNextLine())
//        {
...
//        printList(strings);
        ...
        Scanner sc=new Scanner((new File("./src/main/resources/8exercise.txt")));
        while(sc.hasNextLine())
      {
            strings.add(sc.nextLine());
      }
